...
public class Lexer {
    ...
    public static final int UNARY_MINUS = 14;
    ...
    public String stringify(int token) {
        switch (token) {
            case CONSTANT:
    ...
    public static void main(String[] args) {
        ...
        int s;
        while ( (s = l.nextSymbol()) != Lexer.EOF) if(s != EOL) System.out.println(s + " " + l.stringify(s));
    }
}
